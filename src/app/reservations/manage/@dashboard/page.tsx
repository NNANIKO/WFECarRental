            ...
            </table>
            {
                ...
                <form action={addCar}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-grey-700 pr-4" htmlFor="model">
                            Model
                        </label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-grey-700 pr-4" htmlFor="desc">
                            Description
                        </label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-grey-700 pr-4" htmlFor="seats">
                            Seat
                        </label>
                        ...
                        <label className="w-auto block text-grey-700 pr-4 ml-5" htmlFor="doors">
                            Doors
                        </label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-grey-700 pr-4" htmlFor="largebags">
                            Large Bags
                        </label>
                        <input type="number" required id="largebags" name="largebags" placeholder="2" min={0} max={10}
                        className="bg-white border-2 border-grey-200 rounded w-auto p-2 text-grey-700 focus:outline-none focus:border-blue-400"/>
                        <label className="w-auto block text-grey-700 pr-4 ml-5" htmlFor="smallbags">
                            Small bags
                        </label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-grey-700 pr-4" htmlFor="dayRate">
                            Rate
                        </label>
