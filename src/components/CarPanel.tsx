...
export default function CarPanel() {
    ...
    if (!carResponse) return (<p>Car Penel is Loading...</p>)
    ...
    return (
        <div>
            ...
            rounded-lg p-2 m-2 bg-purple-50 ring-1 ring-inset ring-purple-400 foucus:outline-none
            focus:bg-purple-200 focus:ring-2" ref={inputRef} />
            <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-2
